...
public final class RemoteControlService {
    ...
    private String csrfToken = "", cspNonce = "";
    ...
    public synchronized void start(boolean lan, int port) throws IOException {
        ...
        InetAddress bind = InetAddress.getByName(lan ? "0.0.0.0" : "127.0.0.1"); csrfToken = randomToken(32); cspNonce = randomToken(18); server = HttpServer.create(new InetSocketAddress(bind, port), 20);
